...
<div class="col-6 mx-auto">
    ...
    <form action="{{ route('admin.products.update', $product) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="name" id="name" aria-describedby="helpId" placeholder="Scrivi un titolo per il tuo progetto" value="{{ old('name', $product->name) }}">
        ...
        <div class="mb-3">
            ...
            {{-- utilizziamo la funzione old per ridare all'utente i valori inseriti prima,in caso di errore --}}
            <input type="text" class="form-control" name="price" id="price" aria-describedby="helpId" placeholder="Scrivi il prezzo del tuo piatto" value="{{ old('price', $product->price) }}">
        ...
        <div class="mb-3">
            ...
            {{-- utilizziamo la funzione old per ridare all'utente i valori inseriti prima,in caso di errore --}}
            <input type="text" class="form-control" name="description" id="description" aria-describedby="helpId" placeholder="Scrivi una descrizione per il tuo progetto" value="{{ old('description', $product->description) }}">
        ...
        <div class="mb-3">
            ...
            <input type="file" class="form-control" name="cover_image" id="cover_image" placeholder="Scegli una immagine per il tuo progetto" aria-describedby="cover_image_helper" value="{{ old('cover_image', $product->cover_image) }}">
        ...
        <div class="mb-3">
            ...
            {{-- utilizziamo la funzione old per ridare all'utente i valori inseriti prima,in caso di errore --}}
            <input type="text" class="form-control" name="ingredients" id="ingredients" aria-describedby="help" placeholder="Scrivi gli autori del tuo progetto" value="{{ old('ingredients', $product->ingredients) }}">
